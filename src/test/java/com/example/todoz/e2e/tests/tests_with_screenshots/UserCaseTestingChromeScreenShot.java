package com.example.todoz.e2e.tests.tests_with_screenshots;
...
public class UserCaseTestingChromeScreenShot {
    ...
    private static final String screenShotPath = "/com/example/todoz/e2e/screenshots";
    ...
    public void userCreateNoDueDateTask() {
        //arrange
        String screenShotName = "userCreateNoDueDateTask" + "_screenshot.png";
        //act
        actions.RegisterAndLogin(page, webUrl);
        page.waitForTimeout(2000);
        actions.createFourNoDueDateTasks(page);
        actions.takeScreenshot(screenShotName, page, screenShotPath);
        //assert
        for (int i = 1; i <= 4; i++) {
    ...
    public void CreateThisWeekDueDateTask() {
        ...
        int priority = 4;
        String screenShotName = "CreateThisWeekDueDateTask" + "_screenshot.png";
        //act
        actions.RegisterAndLogin(page, webUrl);
    ...
    public void CreateNextWeekDueDateTask() {
        ...
        String screenShotName = "CreateNextWeekDueDateTask" + "_screenshot.png";
        int priority = 4;
        //act
        actions.RegisterAndLogin(page, webUrl);
    ...
    public void CreateNextTwoWeeksDueDateTask() {
        ...
        String screenShotName = "CreateNextTwoWeeksDueDateTask" + "_screenshot.png";
        int priority = 4;
        //act
        actions.RegisterAndLogin(page, webUrl);
    ...
    public void editTaskPriority() {
        ...
        String screenShotName = "editTaskPriority" + "_screenshot.png";
        int newPriority = 4;
        //act
        actions.RegisterAndLogin(page, webUrl);
        //create new task
    ...
    public void editTaskDescription() {
        ...
        String screenShotName = "editTaskDescription" + "_screenshot.png";
        int newPriority = 4;
        //act
        actions.RegisterAndLogin(page, webUrl);
        //create new task
    ...
    public void editTaskDueDate() {
        ...
        String screenShotName = "editTaskDueDate" + "_screenshot.png";
        int newPriority = 4;
        //act
        actions.RegisterAndLogin(page, webUrl);
        //create new task
